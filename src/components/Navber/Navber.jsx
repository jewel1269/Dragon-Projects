        ...
        <header className="p-4   lg:ml-[450px]  ">
            <div className="container flex justify-around  h-16 mx-auto">
                ...
                <ul className="items-stretch font-Poppins hidden space-x-3 text-xl lg:flex">
                    ...
                    <li className="flex">
                        <NavLink className="flex items-center px-4 -mb-1 ">About</NavLink>
                    </li>
                    <li className="flex">
                ...
                <div className="items-center flex-shrink-0 hidden lg:flex">
                    ...
                    }
                    {
                        user ?
                            ...
                            :
                            <NavLink to={"/login"}>
                                <button className="self-center px-8 py-3 font-Poppins font-semibold rounded btn-outline  bg-slate-300">Login</button>
                            </NavLink>
                    }
